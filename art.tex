...
%Wyjasnic co to jest DOL, skroty i ogolnie prowadzic za reke.
...
%Podsumowanie i odwolanie do tego rownania
\begin{equation}
C(x\cdot e,e\backslash 2,a+c,b-d,g)
\end{equation}
%Co daje zastosowanie systemu parametrycznego
...
Steering characters :
%Wyjasnic te steering characters, zamienic ta liste na tabelke
...
%Wyjasnic po co jest to F i opisac dlaczego kazda litera moze byc litera ktora rysuje linie
...
\bibitem{Herbaceus}Development models of herbaceous plants for computer imagery purposes, 
\bibitem{Sim} Zaniewski T., Bangay S., Simulation and visualization of fire using extended lindenmayer systems
\bibitem{WebTree}Qi H.,Qiu R.,Jia J., L-system based interactive and lightweight web3D tree modeling
...
\bibitem{ABartniak}Bartniak A. , 3D animation of plant development using L-systems, 2013
